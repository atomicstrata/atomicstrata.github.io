...
When someone asks to be forgotten, you need to remove their memory - and only theirs. Atomic Memory partitions memory by scope, so personal, user-scoped facts can be deleted without touching the shared context your team relies on.
