...
When an assistant recalls the wrong thing, the bug is usually retrieval, not the model. AtomicMemory records a retrieval trace for every search and lets you replay any query in the Playground - so you can see exactly which memories came back for a query, and narrow down why.
