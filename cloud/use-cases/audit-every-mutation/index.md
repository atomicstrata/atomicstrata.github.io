...
Memory that changes silently is impossible to defend. When an auditor or an incident asks what your agent remembered - and when it changed - you need a record you can read, not a black box. AtomicMemory captures every change to memory as an inspectable mutation trace.
