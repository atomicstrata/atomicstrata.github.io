...
-   **A running `atomicmemory-core`** at `http://localhost:17350` — start with the [Open Source Quickstart](/open-source/quickstart) (`am init`) or [Core-only Docker](/core-only-docker)
