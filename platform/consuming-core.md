...
| **Docker** | `ghcr.io/atomicstrata/atomicmemory-core:latest` | Local evaluation, self-hosted service boundary, release validation — see [Open Source Quickstart](/open-source/quickstart) |
